...
def create_venue_submission(): 
 # TODO: insert form data as a new Venue record in the db, instead
  ...
  try:
    ...
    address= request.form["address"],facebook_link = request.form["facebook_link"],genres = ','.join(request.form.getlist("genres")),
    website_link = request.form["website_link"],image_link = request.form["image_link"],seeking_talent = bool(request.form.get("seeking_talent")),
...
def edit_venue_submission(venue_id):
  ...
  try:
    ...
    venue.seeking_talent = bool(request.form.get("seeking_venue")) 
...
def create_artist_submission():
  ...
  try:
    ...
    facebook_link=request.form["facebook_link"],genres=','.join(request.form.getlist("genres")),website_link=request.form["website_link"],
    image_link=request.form["image_link"],seeking_venue=bool(request.form.get("seeking_venue")),seeking_description=request.form["seeking_description"] ) 
    db.session.add(artist)
    db.session.commit()
    # on successful db insert, flash success
